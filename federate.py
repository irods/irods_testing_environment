...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Stand up and federate two or more iRODS zones."
    )
    ...
    if args.do_setup:
        ...
        zone_info_list = irods_setup.get_info_for_zones(
            ctx, zone_names, args.consumers_per_zone
        )
